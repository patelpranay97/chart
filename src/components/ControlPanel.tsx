...
export default function ControlPanel() {
  ...
  const advanced = revealed - INITIAL_BARS;
  const futureLeft = MAX_FUTURE - advanced;
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <button
        onClick={endGame}
        className="w-full rounded-lg border border-down/50 py-2.5 text-sm font-semibold text-down transition hover:bg-down/10"
      >
        End Game
      </button>
    </div>
